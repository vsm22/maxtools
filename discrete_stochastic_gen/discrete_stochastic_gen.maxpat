...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 14.0, 276.0, 79.0, 22.0 ],
					"style" : "",
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 643.0, 60.0, 22.0 ],
					"style" : "",
					"text" : "s #0bang"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 166.0, 58.0, 22.0 ],
					"style" : "",
					"text" : "r #0bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 364.0, 90.0, 20.0 ],
					"style" : "",
...
, 			{
				"box" : 				{
					"comment" : "Value triggered",
					"id" : "obj-31",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 332.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 149.5, 276.0, 29.5, 22.0 ],
					"style" : "",
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 118.0, 237.0, 48.0, 22.0 ],
					"style" : "",
					"text" : "route 0"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 364.0, 128.0, 47.0 ],
					"style" : "",
					"text" : "Output 0 when \"null element\" is triggered,\n1 when \"non-null\""
				}

			}
, 			{
				"box" : 				{
					"comment" : "Output 0 when \"null element\" is triggered, 1 when \"non-null\"",
					"id" : "obj-10",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 118.0, 332.0, 30.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 14.0, 237.0, 50.5, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 326.164551, 451.83078, 149.0, 22.0 ],
									"style" : ""
								}
...
,
					"patching_rect" : [ 14.0, 194.0, 269.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"candicane2" : [ 0.870588, 0.415686, 0.062745, 1.0 ],
					"candycane" : 2,
					"id" : "obj-9",
					...
					"outlettype" : [ "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 10.0, 8.0, 135.0, 40.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 80.0, 643.0, 62.0, 22.0 ],
					"style" : "",
					"text" : "send #0js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 14.0, 609.0, 68.0, 22.0 ],
					"style" : "",
					"text" : "route bang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 14.0, 549.0, 46.0, 20.0 ],
					"style" : "",
					"text" : "Trigger"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 472.0, 75.0, 22.0 ],
					"style" : "",
					"text" : "receive #0js"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 14.0, 496.0, 180.0, 22.0 ],
					"saved_object_attributes" : 					{
						"filename" : "discrete_stochastic_gen.js",
						"parameter_enable" : 0
					}
,
					"style" : "",
					"text" : "js discrete_stochastic_gen.js #0"
				}
...
, 			{
		...
		"dependency_cache" : [ 			{
				"name" : "discrete_stochastic_gen.js",
				"bootpath" : "~/Documents/Max 7/Tools/discrete_stochastic_gen",
				"patcherrelativepath" : ".",
				"type" : "TEXT",
				"implicit" : 1
			}
